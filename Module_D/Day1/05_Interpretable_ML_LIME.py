...
# MAGIC [Blog post](https://towardsdatascience.com/decrypting-your-machine-learning-model-using-lime-5adc035109b5)
# MAGIC 
# MAGIC ##### Why should you trust your model?  
# MAGIC 
...
# MAGIC 
# MAGIC ##### [Intuition behind LIME](https://www.kaggle.com/code/prashant111/explain-your-model-predictions-with-lime/notebook)   
# MAGIC 
...
# MAGIC 
# MAGIC What has LIME had to offer on model interpretability?
...
# MAGIC %md
# MAGIC 
# MAGIC #### 1 - Model agnostic explainer [_LIME_].
# MAGIC ##### LIME requires class probabilities in case of classification example  
# MAGIC LightGBM directly returns probability for class 1 by default 
...
# MAGIC %md
# MAGIC #### 2 - Submodular pick (_SP-LIME_) for explaining models
# MAGIC 
