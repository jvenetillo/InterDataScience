...
#airbnbDF = spark.read.option("multiline",True).csv(datapath, inferSchema=True, header=True)   #Spark is not parsing the file correctly, that is why i am reading with Pandas
...
# MAGIC %md
# MAGIC The cells below converts the data to a Delta table using the schema provided by the Spark DataFrame.  
...
# MAGIC %md
# MAGIC ### Checking Table creation in the Database
...
# TO DO WITH YOUR TIMESTAMPS
timeStampString = "2022-10-11T15:57:56.000+0000"
